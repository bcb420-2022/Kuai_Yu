...
normalized_count_data <- read.table("../assignment1/final_counts.csv", 
                                    header = TRUE, 
                                    sep = ",", 
...
ESR-mediated signaling are significantly expressed. Thus, knock-down of RECQ1 correlates
with expression of estrogen signaling and ESR
...
ERa signalling. What's more, author also points out that RECQ1 correlates with 
estrogen. In my analysis, Extra-nuclear estrogen signaling and Mammary gland 
development pathway is down-regulated when RECQ1 is knocked down. This provides 
another supporting evidence for relation between RECQ1 and estrogen.

There are some evidence that support my results.First, we see Cholesterol 
biosynthesis is downregulated when ESR1 is knocked down. There are evidence [@klos2008esr1]
showing that ESR1 plays a role in lipid like cholesterol level.
